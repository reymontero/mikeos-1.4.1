...
; programs (eg Emacs) will have problems running.
;
; Also note that there is currently no way to exit this terminal
; emulator -- you must reboot!
...
erase_sub:
	...
	start_msg	db 'MikeOS minicom -- connecting via serial at 9600 baud...', 13, 10, 0
